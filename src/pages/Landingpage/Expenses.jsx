...
import image from "/assets/expensesImage.svg";
...
const Expenses = () => {
  return (
    <Layout
      id="decison"
      className="lg:py-[4rem]   lg:px-[6.25rem] px-[2rem]   w-full py-[2rem] flex bg-white lg:flex-row-reverse   gap-[2rem] flex-col-reverse justify-start items-center lg:justify-between lg:items-center"
    >
      <div className="lg:w-1/2 w-full  flex h-auto flex-col  items-center justify-start lg:gap-[4rem] gap-[2rem] lg:items-start">
        ...
        <div className=" w-full h-auto gap-[2rem] flex flex-col justify-start items-start">
          ...
          <div className="lg:w-full w-[100%] px-[2rem]  h-auto flex items-center  flex-col gap-[0.69rem] justify-start  lg:justify-start lg:items-start">
